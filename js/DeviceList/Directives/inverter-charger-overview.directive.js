...
angular.module('conext_gateway').directive("inverterChargerOverview", ["imageClickService", "deviceStateSevice",
  function(imageClickService, deviceStateSevice) {
    return {
      restrict: "E",
      replace: true,
      templateUrl: "js/DeviceList/Directives/inverter_charger.html",
      scope: {
        device: "=",
      },
