...
angular.module('conext_gateway').controller("xbdevlistController", [
  ...
  function($scope, $stateParams, xbdevlistService, $interval, devlistQueryService, $timeout, $state, imageClickService) {
          ...
          "Control": [
            {
              ...
              "offset": 0.0,
              "basic": true,
              "enumRef": "XW.DEV.CFG_OPMODE.ENUM",
              "nameRef": "XW.DEV.CFG_OPMODE.SHORTNAME",
              "infoRef": "XW.DEV.CFG_OPMODE.INFO",
    ...
    function getDevices() {
      requestPending = true;
      xbdevlistService.getDevList().then(function(res) {
        var devices = {
          inverters: [],
          chargers: [],
          inverterChargers: [],
        ...
        queryVars = [];
        // $scope.devlist = data.DEVLIST; // Static for now
        var data = {};
        data.DEVLIST = $scope.devlist;
        console.log(data.DEVLIST[0].XW.Control[0])
        devices.inverterChargers.push(data.DEVLIST[0].XW.Control[0]);
