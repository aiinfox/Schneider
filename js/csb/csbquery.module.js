...
// angular .module('conext_gateway') .factory('csbQuery', csbQuery);

// csbQuery.$inject = ['$http', '$q', '$timeout', '$log', '$rootScope', '$window'];

angular.module('conext_gateway').factory('csbQuery', [ 
  '$http', '$q', '$timeout', '$log', '$rootScope', '$window',  
function ( 
  $http, $q, $timeout, $log, $rootScope, $window
  ) {
...
// function csbQuery($http, $q, $timeout, $log, $rootScope, $window) {
